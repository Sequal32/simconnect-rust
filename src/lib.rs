...
impl SimConnector {
    ...
    pub fn add_data_definition(&self, define_id: SIMCONNECT_DATA_DEFINITION_ID, datum_name: &str, units_name: &str, datum_type: SIMCONNECT_DATATYPE, datum_id: DWORD) -> bool {
        unsafe {
            return SimConnect_AddToDataDefinition(self.sim_connect_handle, define_id, as_c_string!(datum_name), as_c_string!(units_name), datum_type, 0.0, datum_id) == 0
        }
    }

    pub fn set_system_event_state(&self, event_id: SIMCONNECT_CLIENT_EVENT_ID, state: SIMCONNECT_STATE) -> bool {
        unsafe {
            return SimConnect_SetSystemEventState(self.sim_connect_handle, event_id, state) == 0
        }
    }

    pub fn remove_client_event(&self, group_id: SIMCONNECT_NOTIFICATION_GROUP_ID, event_id: SIMCONNECT_CLIENT_EVENT_ID) -> bool {
        unsafe {
            return SimConnect_RemoveClientEvent(self.sim_connect_handle, group_id, event_id) == 0
        }
    }

    pub fn clear_notification_group(&self, group_id: SIMCONNECT_NOTIFICATION_GROUP_ID) -> bool {
        unsafe {
            return SimConnect_ClearNotificationGroup(self.sim_connect_handle, group_id) == 0
        }
    }

    pub fn request_notification_group(&self, group_id: SIMCONNECT_NOTIFICATION_GROUP_ID, reserved: DWORD, flags: DWORD) -> bool {
        unsafe {
            return SimConnect_RequestNotificationGroup(self.sim_connect_handle, group_id, reserved, flags) == 0
        }
    }

    pub fn clear_data_definition(&self, define_id: SIMCONNECT_DATA_DEFINITION_ID) -> bool {
        unsafe {
            return SimConnect_ClearDataDefinition(self.sim_connect_handle, define_id) == 0
        }
    }
    ...
    pub fn create_client_data(&self, data_id: SIMCONNECT_CLIENT_DATA_ID, size: DWORD, flags: SIMCONNECT_CREATE_CLIENT_DATA_FLAG) -> bool {
        unsafe {
            return SimConnect_CreateClientData(self.sim_connect_handle, data_id, size, flags) == 0
        }
    }
    ...
    pub fn request_data_on_sim_object_type(&self, request_id: SIMCONNECT_DATA_REQUEST_ID, define_id: SIMCONNECT_DATA_DEFINITION_ID, radius_in_meters: DWORD, object_type: SIMCONNECT_SIMOBJECT_TYPE) -> bool {
        unsafe {
            return SimConnect_RequestDataOnSimObjectType(self.sim_connect_handle, request_id, define_id, radius_in_meters, object_type) == 0
        }
    }

    pub fn remove_input_event(&self, group_id: SIMCONNECT_INPUT_GROUP_ID, input_definition: &str) -> bool {
        unsafe {
            return SimConnect_RemoveInputEvent(self.sim_connect_handle, group_id, as_c_string!(input_definition)) == 0
        }
    }

    pub fn clear_input_group(&self, group_id: SIMCONNECT_INPUT_GROUP_ID) -> bool {
        unsafe {
            return SimConnect_ClearInputGroup(self.sim_connect_handle, group_id) == 0
        }
    }
    ...
    pub fn request_reserved_Key(&self, event_id: SIMCONNECT_CLIENT_EVENT_ID, key_choice_1: &str, key_choice_2: &str, key_choice_3: &str) -> bool {
        unsafe {
            return SimConnect_RequestReservedKey(self.sim_connect_handle, event_id, as_c_string!(key_choice_1), as_c_string!(key_choice_2), as_c_string!(key_choice_3)) == 0
        }
    }

    pub fn unsubscribe_from_system_event(&self, event_id: SIMCONNECT_CLIENT_EVENT_ID) -> bool {
        unsafe {
            return SimConnect_UnsubscribeFromSystemEvent(self.sim_connect_handle, event_id) == 0
        }
    }
    ...
    pub fn ai_create_parked_atc_aircraft(&self, container_title: &str, tail_number: &str, airport_id: &str, request_id: SIMCONNECT_DATA_REQUEST_ID) -> bool {
        unsafe {
            return SimConnect_AICreateParkedATCAircraft(self.sim_connect_handle, as_c_string!(container_title), as_c_string!(tail_number), as_c_string!(airport_id), request_id) == 0
        }        
    }
    ...
    pub fn ai_create_enroute_atc_aircraft(&self, container_title: &str, tail_number: &str, flight_number: i32, flight_plan_path: &str, flight_plan_position: f64, touch_and_go: bool, request_id: SIMCONNECT_DATA_REQUEST_ID) -> bool {
        unsafe {
            return SimConnect_AICreateEnrouteATCAircraft(self.sim_connect_handle, as_c_string!(container_title), as_c_string!(tail_number), flight_number, as_c_string!(flight_plan_path), flight_plan_position, touch_and_go as i32, request_id) == 0
        }
    }
    ...
    pub fn ai_create_non_atc_aircraft(&self, container_title: &str, tail_number: &str, init_pos: SIMCONNECT_DATA_INITPOSITION, request_id: SIMCONNECT_DATA_REQUEST_ID) -> bool {
        unsafe {
            return SimConnect_AICreateNonATCAircraft(self.sim_connect_handle, as_c_string!(container_title), as_c_string!(tail_number), init_pos, request_id) == 0
        }
    }   
    ...
    pub fn ai_create_simulated_object(&self, container_title: &str, init_pos: SIMCONNECT_DATA_INITPOSITION, request_id: SIMCONNECT_DATA_REQUEST_ID) -> bool {
        unsafe {
            return SimConnect_AICreateSimulatedObject(self.sim_connect_handle, as_c_string!(container_title), init_pos, request_id) == 0
        }
    }

    pub fn ai_release_control(&self, object_id: SIMCONNECT_OBJECT_ID, request_id: SIMCONNECT_DATA_REQUEST_ID) -> bool {
        unsafe {
            return SimConnect_AIReleaseControl(self.sim_connect_handle, object_id, request_id) == 0
        }
    }

    pub fn ai_remove_object(&self, object_id: SIMCONNECT_OBJECT_ID, request_id: SIMCONNECT_DATA_REQUEST_ID) -> bool {
        unsafe {
            return SimConnect_AIRemoveObject(self.sim_connect_handle, object_id, request_id) == 0
        }
    }
    ...
    pub fn ai_set_aircraft_flight_plan(&self, object_id: SIMCONNECT_OBJECT_ID, flight_plan_path: &str, request_id: SIMCONNECT_DATA_REQUEST_ID) -> bool {
        unsafe {
            return SimConnect_AISetAircraftFlightPlan(self.sim_connect_handle, object_id, as_c_string!(flight_plan_path), request_id) == 0
        }
    }

    pub fn execute_mission_action(&self, instance_id: GUID) -> bool {
        unsafe {
            return SimConnect_ExecuteMissionAction(self.sim_connect_handle, instance_id) == 0
        }
    }

    pub fn complete_custom_mission_action(&self, instance_id: GUID) -> bool {
        unsafe {
            return SimConnect_CompleteCustomMissionAction(self.sim_connect_handle, instance_id) == 0
        }
    }

    pub fn close(&self) -> bool {
        unsafe {
            return SimConnect_Close(self.sim_connect_handle) == 0
        }
    }

    pub fn get_last_sent_packet_id(&self, error: *mut DWORD) -> bool {
        unsafe {
            return SimConnect_GetLastSentPacketID(self.sim_connect_handle, error) == 0
        }
    }
    ...
    pub fn call_dispatch(&self, dispatch_callback: DispatchProc, context: *mut std::os::raw::c_void) -> bool {
        unsafe {
            return SimConnect_CallDispatch(self.sim_connect_handle, dispatch_callback, context) == 0
        }
    }

    pub fn request_response_times(&self, count: DWORD, elapsed_seconds: *mut f32) -> bool {
        unsafe {
            return SimConnect_RequestResponseTimes(self.sim_connect_handle, count, elapsed_seconds) == 0
        }
    }

    pub fn camera_set_relative_6dof(&self, delta_x: f32, delta_y: f32, delta_z: f32, pitch: f32, bank: f32, heading: f32) -> bool {
        unsafe {
            return SimConnect_CameraSetRelative6DOF(self.sim_connect_handle, delta_x, delta_y, delta_z, pitch, bank, heading) == 0
        }
    }

    pub fn menu_add_item(&self, menu_item: &str, event_id: SIMCONNECT_CLIENT_EVENT_ID, data: DWORD) -> bool {
        unsafe {
            return SimConnect_MenuAddItem(self.sim_connect_handle, as_c_string!(menu_item), event_id, data) == 0
        }
    }

    pub fn menu_delete_item(&self, event_id: SIMCONNECT_CLIENT_EVENT_ID) -> bool {
        unsafe {
            return SimConnect_MenuDeleteItem(self.sim_connect_handle, event_id) == 0
        }
    }

    pub fn menu_delete_sub_item(&self, event_id: SIMCONNECT_CLIENT_EVENT_ID, sub_event_id: SIMCONNECT_CLIENT_EVENT_ID) -> bool {
        unsafe {
            return SimConnect_MenuDeleteSubItem(self.sim_connect_handle, event_id, sub_event_id) == 0
        }
    }

    pub fn request_system_state(&self, request_id: SIMCONNECT_DATA_REQUEST_ID, state: &str) -> bool {
        unsafe {
            return SimConnect_RequestSystemState(self.sim_connect_handle, request_id, as_c_string!(state)) == 0
        }
    }

    pub fn map_client_data_name_to_id(&self, client_data_name: &str, data_id: SIMCONNECT_CLIENT_DATA_ID) -> bool {
        unsafe {
            return SimConnect_MapClientDataNameToID(self.sim_connect_handle, as_c_string!(client_data_name), data_id) == 0
        }        
    }
    ...
    pub fn add_to_client_data_definition(&self, define_id: SIMCONNECT_DATA_DEFINITION_ID, offset: DWORD, size_or_type: DWORD, epsilon: f32, datum_id: DWORD) -> bool {
        unsafe {
            return SimConnect_AddToClientDataDefinition(self.sim_connect_handle, define_id, offset, size_or_type, epsilon, datum_id) == 0
        }
    }

    pub fn clear_client_data_definition(&self, define_id: SIMCONNECT_DATA_DEFINITION_ID) -> bool {
        unsafe {
            return SimConnect_ClearClientDataDefinition(self.sim_connect_handle, define_id) == 0
        }
    }
    ...
    pub fn request_client_data(&self, data_id: SIMCONNECT_CLIENT_DATA_ID, request_id: SIMCONNECT_DATA_REQUEST_ID, define_id: SIMCONNECT_DATA_DEFINITION_ID, period: SIMCONNECT_CLIENT_DATA_PERIOD, flags: SIMCONNECT_CLIENT_DATA_REQUEST_FLAG, origin: DWORD, interval: DWORD, limit: DWORD) -> bool {
        unsafe {
            return SimConnect_RequestClientData(self.sim_connect_handle, data_id, request_id, define_id, period, flags, origin, interval, limit) == 0
        }
    }
    ...
    pub fn set_client_data(&self, data_id: SIMCONNECT_CLIENT_DATA_ID, define_id: SIMCONNECT_DATA_DEFINITION_ID, flags: DWORD, reserved: DWORD, unit_size: DWORD, data_set: *mut std::os::raw::c_void) -> bool {
        unsafe {
            return SimConnect_SetClientData(self.sim_connect_handle, data_id, define_id, flags, reserved, unit_size, data_set) == 0
        }
    }

    pub fn flight_load(&self, file_name: &str) -> bool {
        unsafe {
            return SimConnect_FlightLoad(self.sim_connect_handle, as_c_string!(file_name)) == 0
        }
    }
    ...
    pub fn text(&self, text_type: SIMCONNECT_TEXT_TYPE, time_in_seconds: f32, event_id: SIMCONNECT_CLIENT_EVENT_ID, unit_size: DWORD, data_set: *mut std::os::raw::c_void) -> bool {
        unsafe {
            return SimConnect_Text(self.sim_connect_handle, text_type, time_in_seconds, event_id, unit_size, data_set) == 0
        }
    }

    pub fn subscribe_to_facilities(&self, list_type: SIMCONNECT_FACILITY_LIST_TYPE, request_id: SIMCONNECT_DATA_REQUEST_ID) -> bool {
        unsafe {
            return SimConnect_SubscribeToFacilities(self.sim_connect_handle, list_type, request_id) == 0
        }
    }

    pub fn unsubscribe_to_facilities(&self, list_type: SIMCONNECT_FACILITY_LIST_TYPE) -> bool {
        unsafe {
            return SimConnect_UnsubscribeToFacilities(self.sim_connect_handle, list_type) == 0
        }
    }

    pub fn request_facilities_list(&self, list_type: SIMCONNECT_FACILITY_LIST_TYPE, request_id: SIMCONNECT_DATA_REQUEST_ID) -> bool {
        unsafe {
            return SimConnect_RequestFacilitiesList(self.sim_connect_handle, list_type, request_id) == 0
        }
    }

    pub fn request_data_on_sim_object(&self, request_id: SIMCONNECT_DATA_REQUEST_ID, define_id: SIMCONNECT_DATA_DEFINITION_ID, object_id: SIMCONNECT_OBJECT_ID, period: SIMCONNECT_CLIENT_DATA_PERIOD, flags: SIMCONNECT_DATA_REQUEST_FLAG, origin: DWORD, interval: DWORD, limit: DWORD) -> bool {
        unsafe {
            return SimConnect_RequestDataOnSimObject(self.sim_connect_handle, request_id, define_id, object_id, period, flags, origin, interval, limit) == 0
        }
    }
    ...
    pub fn set_data_on_sim_object(&self, define_id: SIMCONNECT_DATA_DEFINITION_ID, object_id: SIMCONNECT_OBJECT_ID, flags: SIMCONNECT_DATA_SET_FLAG, array_count: DWORD, size: DWORD, pntr: *mut ::std::os::raw::c_void) -> bool {
        unsafe {
            return SimConnect_SetDataOnSimObject(self.sim_connect_handle, define_id, object_id, flags, array_count, size, pntr) == 0
        }
    }

    pub fn subscribe_to_system_event(&self, event_id: SIMCONNECT_CLIENT_EVENT_ID, event_name: &str) -> bool {
        unsafe {
            return SimConnect_SubscribeToSystemEvent(self.sim_connect_handle, event_id, as_c_string!(event_name)) == 0
        }
    }

    pub fn map_client_event_to_sim_event(&self, event_id: SIMCONNECT_CLIENT_EVENT_ID, event_name: &str) -> bool {
        unsafe {
            return SimConnect_MapClientEventToSimEvent(self.sim_connect_handle, event_id, as_c_string!(event_name)) == 0
        }
    }
    ...
    pub fn transmit_client_event(&self, object_id: SIMCONNECT_OBJECT_ID, event_id: SIMCONNECT_CLIENT_EVENT_ID, dw_data: DWORD, group_id: SIMCONNECT_NOTIFICATION_GROUP_ID, flags: SIMCONNECT_EVENT_FLAG) -> bool{
        unsafe {
            return SimConnect_TransmitClientEvent(self.sim_connect_handle, object_id, event_id, dw_data, group_id, flags) == 0
        }
    }
    ...
    pub fn add_client_event_to_notification_group(&self, group_id: SIMCONNECT_NOTIFICATION_GROUP_ID, event_id: SIMCONNECT_CLIENT_EVENT_ID, maskable: bool) -> bool {
        unsafe {
            return SimConnect_AddClientEventToNotificationGroup(self.sim_connect_handle, group_id, event_id, maskable as i32) == 0
        }
    }

    pub fn set_notification_group_priority(&self, group_id: SIMCONNECT_NOTIFICATION_GROUP_ID, priority: DWORD) -> bool {
        unsafe {
            return SimConnect_SetNotificationGroupPriority(self.sim_connect_handle, group_id, priority) == 0
        }
    }
    ...
    pub fn map_input_event_to_client_event(&self, group_id: SIMCONNECT_INPUT_GROUP_ID, input_definition: &str, down_event: SIMCONNECT_CLIENT_EVENT_ID, down_return_value: DWORD, up_event: SIMCONNECT_CLIENT_EVENT_ID, up_return_value: DWORD, maskable: bool) -> bool {
        unsafe {
            return SimConnect_MapInputEventToClientEvent(self.sim_connect_handle, group_id, as_c_string!(input_definition), down_event, down_return_value, up_event, up_return_value, maskable as i32) == 0
        }
    }

    pub fn set_input_group_state(&self, group_id: SIMCONNECT_INPUT_GROUP_ID, state: DWORD) -> bool {
        unsafe {
            return SimConnect_SetInputGroupState(self.sim_connect_handle, group_id, state) == 0
        }
    }

    pub fn set_input_priority(&self, group_id: SIMCONNECT_INPUT_GROUP_ID, priority: DWORD) -> bool {
        unsafe {
            return SimConnect_SetInputGroupPriority(self.sim_connect_handle, group_id, priority) == 0;
        }
    }

...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_var("SIMCONNECT_WAYPOINT_ALWAYS_BACKUP")
        .allowlist_var("SIMCONNECT_WAYPOINT_KEEP_LAST_HEADING")
        .allowlist_var("SIMCONNECT_WAYPOINT_YIELD_TO_USER")
        .allowlist_var("SIMCONNECT_WAYPOINT_CAN_REVERSE")
        ...
        .allowlist_var("SIMCONNECT_PICK_GROUND")
        .allowlist_var("SIMCONNECT_PICK_AI")
        .allowlist_var("SIMCONNECT_PICK_SCENERY")
        .allowlist_var("SIMCONNECT_PICK_ALL")
        .allowlist_var("SIMCONNECT_PICK_COORDSASPIXELS")
        ...
        .allowlist_type("SIMCONNECT_INPUT_EVENT_TYPE")
        .allowlist_type("SIMCONNECT_VOR_FLAGS")
        .allowlist_type("SIMCONNECT_WAYPOINT_FLAGS")
        .allowlist_type("SIMCONNECT_EVENT_FLAG")
        .allowlist_type("SIMCONNECT_DATA_REQUEST_FLAG")
        .allowlist_type("SIMCONNECT_DATA_SET_FLAG")
        .allowlist_type("SIMCONNECT_CREATE_CLIENT_DATA_FLAG")
        .allowlist_type("SIMCONNECT_CLIENT_DATA_REQUEST_FLAG")
        .allowlist_type("SIMCONNECT_CLIENT_DATA_SET_FLAG")
        .allowlist_type("SIMCONNECT_VIEW_SYSTEM_EVENT_DATA")
        .allowlist_type("SIMCONNECT_SOUND_SYSTEM_EVENT_DATA")
        .allowlist_type("SIMCONNECT_PICK_FLAGS")
        ...
        .allowlist_type("SIMCONNECT_RECV_EVENT_EX1")
        ...
        .allowlist_type("SIMCONNECT_ICAO")
        .allowlist_type("SIMCONNECT_FACILITY_MINIMAL")
        .allowlist_type("SIMCONNECT_RECV_FACILITY_MINIMAL_LIST")
        .allowlist_type("SIMCONNECT_DATA_PBH")
        .allowlist_type("SIMCONNECT_JETWAY_DATA")
        .allowlist_type("SIMCONNECT_RECV_JETWAY_DATA")
        .allowlist_type("SIMCONNECT_RECV_ACTION_CALLBACK")
        .allowlist_type("SIMCONNECT_INPUT_EVENT_DESCRIPTOR")
        .allowlist_type("SIMCONNECT_RECV_ENUMERATE_INPUT_EVENTS")
        .allowlist_type("SIMCONNECT_RECV_GET_INPUT_EVENT")
        .allowlist_type("SIMCONNECT_RECV_SUBSCRIBE_INPUT_EVENT")
        .allowlist_type("SIMCONNECT_RECV_ENUMERATE_INPUT_EVENT_PARAMS")
        .allowlist_type("SIMCONNECT_VERSION_BASE_TYPE")
        .allowlist_type("SIMCONNECT_CONTROLLER_ITEM")
        .allowlist_type("SIMCONNECT_RECV_CONTROLLERS_LIST")
        .allowlist_type("SIMCONNECT_RECV_LIST_TEMPLATE")
        ...
        .allowlist_function("SimConnect_SubscribeToFacilities_EX1")
        .allowlist_function("SimConnect_UnsubscribeToFacilities_EX1")
        .allowlist_function("SimConnect_RequestFacilitiesList_EX1")
        .allowlist_function("SimConnect_RequestFacilityData_EX1")
        .allowlist_function("SimConnect_RequestJetwayData")
        .allowlist_function("SimConnect_EnumerateControllers")
        .allowlist_function("SimConnect_MapInputEventToClientEvent_EX1")
        .allowlist_function("SimConnect_ExecuteAction")
        .allowlist_function("SimConnect_EnumerateInputEvents")
        .allowlist_function("SimConnect_GetInputEvent")
        .allowlist_function("SimConnect_SetInputEvent")
        .allowlist_function("SimConnect_SubscribeInputEvent")
        .allowlist_function("SimConnect_UnsubscribeInputEvent")
        .allowlist_function("SimConnect_EnumerateInputEventParams")
        .allowlist_function("SimConnect_AddFacilityDataDefinitionFilter")
